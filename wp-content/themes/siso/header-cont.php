...
<link href="<?php bloginfo('template_directory'); ?>/css/contact.css" rel="stylesheet" type="text/css"/>
...
<nav class="navbar navbar-toggleable-sm navbar-light">
  ...
  <div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
    <ul class="nav navbar-nav float-sm-right float-xs-right">
		...
		<li class="nav-item"><a class="nav-link active" href="<?php echo site_url(); ?>/contact-us">CONTACT US</a></li>
    </ul>
  </div>
</nav>
</div>
